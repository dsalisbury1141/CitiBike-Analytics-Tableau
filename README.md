...
Please note that this repository is a reflection of the Tableau homework, to include Tableau Public links The dataset are extremely large, too big to save to GITHUB repository take a look at this awesome data from the CitiBike data system
...
<h3>Data used for this assignment came from the public Citi Bike Data webpage. https://www.citibikenyc.com/system-data</h3>
